...
def get_DTSP_training_data():
    train = TSPDataset('/TSP100/train')
    val = TSPDataset('/TSP100/val')
    test = TSPDataset('/TSP100/test')
...
def get_CTSP_training_data():
    train = "ConvTSP/TSP100/tsp100_train_concorde.txt"
    val = "ConvTSP/TSP100/tsp100_val_concorde.txt"
    test = "ConvTSP/TSP100/tsp100_test_concorde.txt"
...
class GoogleTSPReader(object):
    ...
    def process_batch(self, problems=None):
        ...
        for line_num, instance in enumerate(problems):
            nodes_coord = instance.tolist()
