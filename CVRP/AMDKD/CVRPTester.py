...
from utils import *
from CVRP.LKHSolver import get_lkh_solutions
...
class CVRPTester:
    ...
    def _test_one_batch(self, batch_size,episode=None):
        ...
        optimal_score = torch.tensor(
            get_lkh_solutions(self.env.depot_xy, self.env.node_xy, self.env.node_demand, self.env_params['problem_size']))
        gap = -max_aug_pomo_reward - torch.tensor(optimal_score)
